...
# =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
# IPP - csv - doplňkové testy - 2016/2017
# =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
# Činnost:
...
$INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH}test01.csv --output=${LOG_PATH}test01.xml 2> ${LOG_PATH}test01.err
echo -n $? > ${LOG_PATH}test01.!!!

# test02: custom line element with dash; Expected output: test02.xml; Expected return code: 0
$INTERPRETER $TASK.$EXTENSION -l="ra-dek" --input=${LOCAL_IN_PATH}test02.csv > ${LOG_PATH}test02.xml  2> ${LOG_PATH}test02.err
...
$INTERPRETER $TASK.$EXTENSION -l=radek -r=root --input=${LOCAL_IN_PATH2}test03.csv -i -n > ${LOG_PATH}test03.xml 2> ${LOG_PATH}test03.err
echo -n $? > ${LOG_PATH}test03.!!!

# test04: semicolon as a separator; Expected output: test04.xml; Expected return code: 32
$INTERPRETER $TASK.$EXTENSION -s=\; > "${LOG_PATH}test04.xml" < ${LOCAL_IN_PATH}test04.csv 2> ${LOG_PATH}test04.err
...
$INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH}test05.csv -s=\; -e > "${LOG_PATH}test05.xml" 2> ${LOG_PATH}test05.err
...
$INTERPRETER $TASK.$EXTENSION --start=2 --input=${LOCAL_IN_PATH}test06.csv --output=${LOG_PATH}test06.xml -h -i -l=data 2> ${LOG_PATH}test06.err
echo -n $? > ${LOG_PATH}test06.!!!

# test07: quotas versus apostrophes; Expected output: test07.xml; Expected return code: 0
$INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH}test07.csv --output=${LOG_PATH}test07.xml  2> ${LOG_PATH}test07.err
echo -n $? > ${LOG_PATH}test07.!!!

# test08: apostrophes versus quotas; Expected output: test08.xml; Expected return code: 0
$INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH}test08.csv --output=${LOG_PATH}test08.xml  2> ${LOG_PATH}test08.err
echo -n $? > ${LOG_PATH}test08.!!!

# test09: tests diacritics in elements and cells; Expected output: test09.xml; Expected return code: 0
$INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH}test09.csv -h --output=${LOG_PATH}test09.xml  -r=róót 2> ${LOG_PATH}test09.err
...
$INTERPRETER $TASK.$EXTENSION -h --input=${LOCAL_IN_PATH}test10.csv --output=${LOG_PATH}test10.xml  2> ${LOG_PATH}test10.err
...
$INTERPRETER $TASK.$EXTENSION -l=line -i --input=${LOCAL_IN_PATH}test11.csv --output=${LOG_PATH}test11.xml 2> ${LOG_PATH}test11.err
...
$INTERPRETER $TASK.$EXTENSION -h --input=${LOCAL_IN_PATH}test12.csv --output=${LOG_PATH}test12.xml 2> ${LOG_PATH}test12.err
echo -n $? > ${LOG_PATH}test12.!!!

# test13: TAB (	) separator, indexing starts at 5; Expected output: test13.xml; Expected return code: 0
$INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH2}test13.csv --start=5 -i --output=${LOG_PATH}test13.xml -s=TAB -l=row 2> ${LOG_PATH}test13.err
echo -n $? > ${LOG_PATH}test13.!!!

# test14: TAB (	) separator, the header with diacritics; Expected output: test14.xml; Expected return code: 0
$INTERPRETER $TASK.$EXTENSION -s=TAB -h --input=${LOCAL_IN_PATH2}test14.csv --output=${LOG_PATH}test14.xml 2> ${LOG_PATH}test14.err
...
$INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH2}test15.csv -r=root --output="${LOG_PATH}test15.xml" 2> ${LOG_PATH}test15.err
...
$INTERPRETER $TASK.$EXTENSION --all-columns -e -r=root --input="${LOCAL_IN_PATH3}test16.csv" --output=${LOG_PATH}test16.xml 2> ${LOG_PATH}test16.err
...
$INTERPRETER $TASK.$EXTENSION --error-recovery -r=" root" --input="${LOCAL_IN_PATH3}test17.csv" --output=${LOG_PATH}test17.xml 2> ${LOG_PATH}test17.err
...
$INTERPRETER $TASK.$EXTENSION -e -h=jk --all-columns --missing-field=chybí -c=Kontakt --input="${LOCAL_IN_PATH3}test18.csv" --output="${LOG_PATH}test18.xml" 2> ${LOG_PATH}test18.err
