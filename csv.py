...
class csv2xml:
    ...
    def parseCmdArgs(self):
        ...
        args.add_argument('-c', dest='column_element', action='store', nargs='?', const='col', help='určuje prefix jména elementu column-elementX, který bude obalovat nepojmenované sloupce (implicitně col)')
